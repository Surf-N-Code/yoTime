...
class UserHelpHandler
{
    public function showUserHelp(SlashCommand $command)
    {
        ...
        $m->addTextSection(sprintf(':white_check_mark: `%s` will start a work timer for you. Use this to start a work timer after your break for example.', SlashCommandHandler::START_WORK));
