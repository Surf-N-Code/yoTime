...
use App\Entity\User;
use App\Services\DateTimeProvider;use Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepository;
...
class TimeEntryRepository extends ServiceEntityRepository
{
    ...
    */
     ...
     * @param \App\Entity\User      $user
     *
     * @return \App\Entity\TimeEntry|null
     */
     ...
     */
    public function findLatestRunningTimerByType(User $user, string $timerType): ?TimeEntry
    {
